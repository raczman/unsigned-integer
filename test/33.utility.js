...
describe('Utility', function () {
	specify('Integer#bitSizeAbs()', function () {
		...
		expect(Integer(-255).bitSizeAbs()).to.equal(64);
	...
	specify('Integer#isSafe()', function () {
		...
		expect(Integer(-3).isSafe()).to.be.false;
		...
		expect(Integer(Number.MIN_SAFE_INTEGER).isSafe()).to.be.false;
	...
	specify('Integer#isUnsafe()', function () {
		...
		expect(Integer(-3).isUnsafe()).to.be.true;
		...
		expect(Integer(Number.MIN_SAFE_INTEGER).isUnsafe()).to.be.true;
