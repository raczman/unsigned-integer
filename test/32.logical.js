...
describe('Logical operations', function () {
	specify('Integer#equals()', function () {
		...
		expect(Integer(-1).equals(Integer.fromString("ffffffffffffffff", 16))).to.be.true;
	});
	...
	specify('Integer#greaterThan()', function () {
		...
		expect(Integer('9223372036854775807').greaterThan(Integer('9223372036854775807'))).to.be.false;
	});
	specify('Integer#lessThan()', function () {
		expect(Integer().lessThan('0')).to.be.false;
		expect(Integer('23453').lessThan(-23453)).to.be.true;
		expect(Integer('9223372036854775807').lessThan(Integer('9223372036854775808'))).to.be.true;
	});
	specify('Integer#greaterThanOrEquals()', function () {
		...
		expect(Integer('9223372036854775807').greaterThanOrEquals(Integer('9223372036854775808'))).to.be.false;
	});
	specify('Integer#lessThanOrEquals()', function () {
		...
		expect(Integer('9223372036854775807').lessThanOrEquals(Integer('9223372036854775808'))).to.be.true;
	});
